...
import { logoutLoader } from '../views/logout';
import appLoader from '../services/utils/appLoader';
import { restaurantProfileLoader } from '../views/restaurant';
import ProtectedRoute from './protectedRoute';
// import { actions } from 'react-table';
/****Layouts*****/

const T = Loadable(lazy(() => import('../views/logout')));
...
const RestaurantInfo = Loadable(lazy(() => import('../views/restaurant')));
const Bookings = Loadable(lazy(() => import('../views/bookings')));
const SpecialOffer = Loadable(lazy(() => import('../views/specialOffer')));
...
const EmailVerification = Loadable(lazy(() => import('../views/auth/emailVerification')));
...
const ThemeRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'resetpwd', element: <ResetPassword /> },
      // { path: '*', element: <Navigate to="/auth/404" /> },
    ],
  },
  {
