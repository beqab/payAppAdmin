...
import { UpdateNote } from '../../../store/apps/SpecialOffers/SpecialOffersSlice';
...
const NoteDetail = () => {
  const noteDetails = useSelector(
    (state) =>
      state.SpecialOffersReducer.SpecialOffers[state.SpecialOffersReducer.SpecialOffersContent - 1],
  );
